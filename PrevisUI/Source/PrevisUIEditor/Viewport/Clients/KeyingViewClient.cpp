#include "KeyingViewClient.h"
#include "Engine/Canvas.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "Materials/MaterialExpressionConstant4Vector.h"

FKeyingViewClient::FKeyingViewClient() :
...
void FKeyingViewClient::Draw(FViewport* _viewport, FCanvas* _canvas)
{
	// Clear entire canvas
...
void FKeyingViewClient::SetMaterial(UMaterialInstanceDynamic* _renderingMaterial)
{
